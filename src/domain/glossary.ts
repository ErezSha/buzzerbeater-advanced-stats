...
export const glossaryEntries: GlossaryEntry[] = [
  ...
  },
  {
    id: "ast",
    name: "AST%",
    formula: "AST / (Tm FGM − FGM)",
    interpretation: "Fraction of teammate made field goals the player assisted on.",
    availability: "Shown when team and player field goal makes are available.",
  },
  {
    id: "blk",
    name: "BLK%",
    formula: "BLK / Opp 2PA  (Opp 2PA = Opp FGA − Opp 3PA)",
    interpretation: "Blocks per opponent two-point attempt — defensive disruption rate.",
    availability: "Shown when opponent field goal attempts are available.",
  },
  {
    id: "stl",
    name: "STL%",
    formula: "STL / Opp possessions  (possessions = FGA + 0.44 × FTA − ORB + TOV)",
    interpretation: "Steals as a share of opponent possessions — how often the player forces a turnover.",
    availability: "Shown when opponent possession components are available.",
  },
  {
    id: "trb",
    name: "TRB%",
    formula: "TRB / (Tm TRB + Opp TRB)",
    interpretation: "Share of all available rebounds the player grabbed.",
    availability: "Shown when team and opponent total rebounds are available.",
  },
  {
    id: "usg",
    name: "USG%",
    formula: "(FGA + 0.44 × FTA + TOV) / (Tm FGA + 0.44 × Tm FTA + Tm TOV)",
    interpretation: "Share of team possessions the player used via shots, free throws, or turnovers.",
    availability: "Shown when player and team shooting attempts and turnovers are available.",
  },
  {
    id: "game-score",
    name: "Game Score",
